...
class DocumentTopicManager:
    ...
    file with the structure::
        ...
        {"name": "Reports", "docs": ["project-id-1", "project-id-2"]}
    ...
    def delete(self, name: str) -> None:
        """Delete a topic and its directory.  Documents are not affected."""
    ...
    def add_doc(self, topic: str, project_id: str) -> None:
        """Add a document reference to a topic.  Idempotent."""
    ...
    def remove_doc(self, topic: str, project_id: str) -> None:
        """Remove a document reference from a topic."""
        meta, meta_path = self._resolve(topic)
        docs = meta["docs"]
        if project_id not in docs:
