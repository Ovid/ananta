...
from ananta.explorers.shared_ui.schemas import ExchangeSchema, TopicInfo
...
def test_web_schemas_reexport_shared_topic_info() -> None:
    ...
    from ananta.explorers.arxiv.schemas import TopicInfo as WebTopicInfo
...
def test_web_schemas_reexport_shared_exchange() -> None:
    ...
    from ananta.explorers.arxiv.schemas import ExchangeSchema as WebExchange
