...
from ananta.explorers.shared_ui.websockets import _handle_query, handle_multi_project_query
...
class TestHandleQueryDocIdValidation:
    ...
    async def test_accepts_valid_document_ids(self) -> None:
        ...
        with patch(
            "ananta.explorers.shared_ui.websockets.WebConversationSession",
