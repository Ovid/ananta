...
class TestExtractFromBib:
    ...
    def test_extract_single_entry(self) -> None:
        from ananta.experimental.arxiv.citations import extract_citations_from_bib
...
class TestExtractFromBbl:
    ...
    def test_extract_bibitem(self) -> None:
        from ananta.experimental.arxiv.citations import extract_citations_from_bbl
...
class TestDetectLLMPhrases:
    ...
    def test_detect_knowledge_update_phrase(self) -> None:
        from ananta.experimental.arxiv.citations import detect_llm_phrases
...
class TestExtractFromText:
    ...
    def test_extract_arxiv_ids_from_text(self) -> None:
        from ananta.experimental.arxiv.citations import extract_citations_from_text
...
class TestArxivIdPattern:
    ...
    def test_valid_standard_id(self) -> None:
        from ananta.experimental.arxiv.citations import ARXIV_ID_PATTERN
...
class TestVerificationStatusExtended:
    ...
    def test_verified_external_status_exists(self) -> None:
        from ananta.experimental.arxiv.models import VerificationStatus
...
class TestFuzzyTitleMatch:
    ...
    def test_exact_match_returns_high_score(self) -> None:
        from ananta.experimental.arxiv.citations import title_similarity
