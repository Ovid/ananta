...
class TestExtractTarball:
    ...
    def test_extract_tex_and_bib(self) -> None:
        from ananta.explorers.arxiv.papers.download import extract_source_files
...
class TestDownloadPaper:
    ...
    @patch("ananta.explorers.arxiv.papers.download.urllib.request.urlopen")
    ...
    def test_urlopen_called_with_timeout(self, mock_urlopen: MagicMock, tmp_path: Path) -> None:
        from ananta.explorers.arxiv.papers.cache import PaperCache
        from ananta.explorers.arxiv.papers.download import (
