...
class TestArxivSearcher:
    ...
    @patch("ananta.explorers.arxiv.papers.search.arxiv")
    ...
    def test_format_result(self) -> None:
        ...
        from ananta.explorers.arxiv.papers.search import format_result
    ...
    def test_extract_arxiv_id_from_entry_id(self) -> None:
        # Late import: module under test
        from ananta.explorers.arxiv.papers.search import extract_arxiv_id
