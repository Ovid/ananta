...
from ananta.explorers.code.__main__ import main, parse_args
...
class TestMain:
    ...
    @patch("ananta.explorers.code.__main__.parse_args")
    @patch("ananta.explorers.code.__main__.uvicorn")
    @patch("ananta.explorers.code.__main__.create_api")
    @patch("ananta.explorers.code.__main__.create_app_state")
    ...
    @patch("ananta.explorers.code.__main__.create_api")
    @patch("ananta.explorers.code.__main__.create_app_state")
    @patch("ananta.explorers.code.__main__.threading")
    @patch("ananta.explorers.code.__main__.webbrowser")
