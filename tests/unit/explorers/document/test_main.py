...
from ananta.explorers.document.__main__ import main, parse_args
...
class TestMain:
    @patch("ananta.explorers.document.__main__.parse_args")
    @patch("ananta.explorers.document.__main__.uvicorn")
    @patch("ananta.explorers.document.__main__.create_api")
    @patch("ananta.explorers.document.__main__.create_app_state")
